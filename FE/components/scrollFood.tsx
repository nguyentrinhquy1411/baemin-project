                        ...
                        >
                            {items.items.map((item: ScrollFoodItem, index: number) => (
                                ...
                                >
                                    <div className="w-full relative rounded-t-lg overflow-hidden" style={{ height: '160px' }}>
                                    ...
                                    </div>                                    <div className="group-hover:bg-slate-50 w-full flex flex-col px-3 py-2 transition-colors duration-200" style={{ height: '100px' }}>
                                        ...
                                        <div className="w-full flex items-center justify-between text-sm border-t border-gray-100 pt-2 mt-auto">
                                            ...
                                            {item.rating && !item.badge && (
                                                <span className="text-amber-500 font-medium whitespace-nowrap flex items-center">
                                                    {item.rating.toFixed(1)} <span className="ml-0.5">★</span>
                                                </span>
                                            )}
                                        </div>
                                    </div>
